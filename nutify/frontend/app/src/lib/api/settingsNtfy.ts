...
export async function testNtfyConfig(configId: number, targetId: number | null) {
  return requestSettingsJson(`/api/ntfy/test/${configId}`, { method: 'POST' }, targetId)
}

export async function testNtfyConfigEvent(configId: number, eventType: string, targetId: number | null) {
  return requestSettingsJson(
...
export async function testNtfyRawConfig(input: JsonRecord, targetId: number | null) {
  return requestSettingsJson(
    '/api/ntfy/test',
    {
      method: 'POST',
