...
export async function testWebhookConfig(configId: number, _targetId: number | null) {
  return requestSettingsJson(`/api/webhook/test/${configId}`, { method: 'POST' })
}
...
export async function testWebhookConfigEvent(configId: number, eventType: string, _targetId: number | null) {
  return requestSettingsJson(
...
export async function testWebhookRawConfig(input: JsonRecord, _targetId: number | null) {
  return requestSettingsJson(
    '/api/webhook/test',
    {
      method: 'POST',
